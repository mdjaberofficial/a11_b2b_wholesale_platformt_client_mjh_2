  ...
  return (
    <div className="navbar bg-base-100 shadow-sm sticky top-0 z-50">
      <div className="navbar-start">
        ...
        <Link to="/" className="btn btn-ghost text-xl font-bold text-primary">B2B Wholesale</Link>
      </div>
            ...
            <div className="tooltip tooltip-bottom" data-tip={user?.displayName || "User"}>
              <div className="avatar">
                <div className="w-10 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                  <img src={user?.photoURL || "https://i.ibb.co/M8mYfCW/default-avatar.png"} alt="User Profile" />
                </div>
              </div>
            </div>
            <button onClick={handleLogOut} className="btn btn-error text-white btn-sm md:btn-md">Logout</button>
          </div>
        ) : (
          <>
